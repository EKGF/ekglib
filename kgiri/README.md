...
These helpers are used throughout `ekg_lib` to keep knowledge graph identifiers consistent and well-structured.
...
```python
from ekg_lib.kgiri import kgiri_with, kgiri_random, set_kgiri_base

...
- link:ekglib/story_validate_rule_parser/[Story Validate Rule Parser]
- link:ekglib/story_validate_rules_capture/[Story Vaidate Rules Capture]
- link:ekglib/story_validate_rules_execute/[Story Validate Rules Executor]

...
_SPARQL_MIME_TYPES = [MIME_TURTLE, MIME_RDFXML, MIME_NTRIPLES, MIME_TRIG, MIME_NQUADS,
                      MIME_N3, MIME_TRIX, MIME_JSONLD,
                      MIME_SPARQLRESULTS_XML, MIME_SPARQLRESULTS_JSON,
                      MIME_XBINARY, MIME_BOOLEAN, MIME_CSV, MIME_TSV, MIME_TSV2]

__all__ = [
    'MIME_TURTLE', 'MIME_RDFXML', 'MIME_NTRIPLES', 'MIME_TRIG', 'MIME_NQUADS',
    'MIME_N3', 'MIME_TRIX', 'MIME_JSONLD',
    'MIME_SPARQLRESULTS_XML', 'MIME_SPARQLRESULTS_JSON',
    'MIME_XBINARY', 'MIME_BOOLEAN', 'MIME_CSV', 'MIME_TSV', 'MIME_TSV2',

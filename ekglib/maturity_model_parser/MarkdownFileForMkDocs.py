# Python
#
# Most of this code is copied from the MdUtils package: https://github.com/didix21/mdutils
#
...
class MarkDownFileForMkDocs(object):
    ...
    def append_after_second_line(self, data):
        ...
        :param str data: is a string containing all the data that is written in the markdown file."""
        with mkdocs_gen_files.open(self.file_name, 'r+', encoding='utf-8') as self.file:

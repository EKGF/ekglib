...
MIME type constants and helpers used by `ekg_lib` components that need to work with content types.
...
```python
from ekg_lib.mime import MIME_TURTLE, check_sparql_mime_type
